...
class MetricsRegistryTests(TestCase):
    ...
    def test_getters_create_metrics(self):
        ...
        for metric in ("counter_count", "histogram_avg", "histogram_max",
                       ...
                       "timer_999_percentile", "timer_15m_rate", "timer_5m_rate",
                       "timer_1m_rate", "timer_mean_rate"):
            self.assertTrue(metric in [stat["name"] for stat in dump])
